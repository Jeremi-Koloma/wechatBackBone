...
public class Constants {
    // chemin d'accès pour stocker les photos de profil des utilsateurs
    public static final String USER_FOLDER = "src/main/resources/static/image/user_profiles//";
    ...
    public static final String POST_FOLDER = "src/main/resources/static/image/posts//";
}
